...
const homePageLoad = () => {
    ...
    const renderMain = () => {
        ...
        backgroundImage.setAttribute("alt", "A landscape picture of the mountains covered in snow");

        // Create bg img p element & class
        const bgImgPara = document.createElement("p");
        bgImgPara.classList.add("bg-img-headline");
        bgImgPara.textContent = "Come experience our tasty meals with a fantastic view! We offer a wide variety of food and the atmosphere is fantastic";
        ...
        backgroundImage.appendChild(button);
